class Plotting():
    def __init__(self, xlabel: str = "Time (s)", ylabel: str = "Force (mN)", **kwargs) -> None:
        ...
        # self.MinY, self.MaxY = -2000,2000        #minimum/maximum plotting Y
    ...
    def _init_fig(self) -> None:
        ...
        #1: Create plot
        self.fig , self.ax1 = self.plt.subplots( 1 )
    ...
    def Update(self, data) -> None:
        ...
        self.ax1.set_ylim( min(data[1])-abs(min(data[1]))/10, max(data[1])+abs(max(data[1]))/10 )
